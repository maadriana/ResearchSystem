<div>
    ...
    {{-- SIDE BAR --}}
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('faculty-track-proposal') }}" class="btn btn-light active text-dark d-flex align-items-center mb-2">
        ...
        <main class="container-fluid p-4">
            <h2 class="text-center mb-4">Research Proposal Tracking</h2>
            <div class="card m-3">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Submission Date:</strong> September 12, 2024</p>
                    <hr>
                    <h6><strong>Status:</strong></h6>
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Proposal Submitted <span class="badge bg-success">Completed</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Format Compliance <span class="badge bg-success">Completed</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Ethical Standards <span class="badge bg-warning">In Progress</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Schedule of Presenting Proposal <span class="badge bg-secondary">Pending</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            UREC Presentation <span class="badge bg-secondary">Pending</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Contract Signing <span class="badge bg-secondary">Pending</span>
                        </li>
                    </ul>
                </div>
            </div>
